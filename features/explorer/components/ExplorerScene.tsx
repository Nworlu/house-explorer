...
type ExplorerSceneProps = { modelUrl: string; initialCamera: CameraConfig; activeCamera: CameraConfig };

export function ExplorerScene({ modelUrl, initialCamera, activeCamera }: ExplorerSceneProps) {
  ...
  return (
    ...
    >
      ...
      <Suspense fallback={null}><PropertyModel url={modelUrl} /></Suspense>
      ...
      <OrbitControls
        ref={setControls}
        makeDefault target={initialCamera.target} minDistance={2.5} maxDistance={28}
