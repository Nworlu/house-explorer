  ...
  return (
    <main className="viewer-shell">
      ...
      <section className="viewer-stage" aria-label={`3D view of ${property.name}`}>
        <SceneErrorBoundary><ExplorerScene modelUrl={property.modelUrl} initialCamera={initialCamera} activeCamera={activeCamera} cutaway={Boolean(selectedRoom)} floors={property.floors} visibleFloorId={selectedFloorId} /></SceneErrorBoundary>
        <ExplorerLoading />
